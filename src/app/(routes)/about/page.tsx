          ...
          <div>
            ...
            <div className="flex flex-wrap gap-6 text-slate-600">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  Open to High-Impact Freelance Projects & Full-Time Roles
                </span>
              </div>
            </div>
          </div>
            ...
            <Card className="p-6 hover:shadow-md transition-shadow">
              ...
              <ul className="space-y-3 ml-4 list-disc text-slate-600 marker:text-cyan-500">
                <li>
                  ...
                  Collaborated with senior engineers to refactor legacy
                  codebases, optimizing RESTful API endpoints and contributing
                  to a <strong>30% improvement in conversion rates</strong>.
                </li>
                <li>
                  <strong className="text-slate-900">
                    Fintech Integration:
                  </strong>{" "}
                  Engineered a fault-tolerant Stripe payment gateway with
                  webhook handlers, ensuring a{" "}
                  <strong>99.8% transaction success rate</strong>.
                </li>
                <li>
                  <strong className="text-slate-900">
                    System Architecture:
                  </strong>{" "}
                  Independently designed a secure, multi-tenant invoice module
                  with strict database isolation, reducing cross-tenant risks by{" "}
                  <strong>95%</strong>.
                </li>
                <li>
                  <strong className="text-slate-900">Performance:</strong>{" "}
                  Identified and resolved N+1 query issues, reducing API
                  response times by <strong>45%</strong>.
                </li>
                <li>
                  <strong className="text-slate-900">Agile Leadership:</strong>{" "}
                  Championed code quality through peer reviews and actively
              ...
              <div className="mt-6 pt-4 border-t flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tech}
                    className="px-2.5 py-0.5 bg-slate-100 text-slate-600 text-xs font-medium rounded-md border border-slate-200"
                  >
                    {tech}
                  </span>
                ))}
