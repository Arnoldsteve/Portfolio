...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background px-4 sm:px-6 py-4 sm:py-0 max-w-7xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="p-8">
            <p className="text-lg text-muted-foreground leading-relaxed mb-4">
              ...
              React, Node.js, and PHP ecosystems. My passion lies in
              architecting robust backend systems and creating seamless user
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              that reduced vulnerabilities by 95%. I leverage agile
              methodologies to enhance team velocity and deliver exceptional
              ...
              <div className="flex-1">
                ...
                <div className="p-4 bg-muted rounded-lg">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    architecting a secure, isolated database structure that
                    became a core component of a commercial platform.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-6 text-center">
              ...
              <p className="text-muted-foreground text-sm">
                I focus on metrics that matter - 30% conversion increases and
                95% security improvements speak for themselves.
              </p>
            </Card>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-muted-foreground text-sm">
                I thrive in collaborative environments, improving team velocity
                by 25% through effective agile practices.
              </p>
            </Card>
          </div>
        </div>
      ...
      {/* Final CTA */}
      <section className="container mx-auto px-4 py-16 bg-gradient-to-r from-cyan-400/10 to-cyan-400/5">
