...
const socialLinks = [
  {
    ...
    hoverColor:
      "hover:text-[#0077B5] hover:drop-shadow-[0_0_10px_rgba(0,119,181,0.4)]",
  },
  {
    name: "GitHub",
    ...
    hoverColor:
      "hover:text-black dark:hover:text-white hover:drop-shadow-[0_0_10px_rgba(0,0,0,0.3)]",
  },
  {
    name: "GitLab",
    ...
    hoverColor:
      "hover:text-[#FC6D26] hover:drop-shadow-[0_0_10px_rgba(252,109,38,0.4)]",
  },
  {
    name: "WhatsApp",
    ...
    hoverColor:
      "hover:text-[#25D366] hover:drop-shadow-[0_0_10px_rgba(37,211,102,0.4)]",
  },
];
...
export const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative pt-10 pb-20 lg:pt-32 overflow-hidden"
    >
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              I am a <strong>Full-Stack Software Engineer</strong> dedicated to
              transforming business goals into high-performing digital products.
              From high-converting corporate websites to complex custom
              applications, I build secure, scalable, and world-class solutions
              for a global market.
            </p>

            <div className="mt-8 flex flex-row w-full lg:w-fit gap-4 justify-center lg:justify-start">
              ...
              >
                <Button
                  size="lg"
                  variant="outline"
                  className="border-slate-300 hover:bg-slate-50 w-full h-12 px-8"
                >
