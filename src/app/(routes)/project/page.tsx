    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <section className="grid lg:grid-cols-2 gap-12 items-start mb-20">
          {/* Left: Image */}
          <div className="relative aspect-[16/10] w-full rounded-2xl overflow-hidden shadow-xs">
            <Image
              src={project.image}
              alt={project.title}
              fill
              ...
              {project.github && (
                <Button asChild variant="outline" className="border-slate-300">
                  <a href={project.github}>
                    {project.github.startsWith("mailto:") ? (
                      <>
              ...
              <section>
                ...
                <div className="grid sm:grid-cols-1 gap-4">
                  {project.keyFeatures.map((feature, index) => (
                    <Card
                      key={index}
                      className="border-l-4 border-l-cyan-400 shadow-sm hover:shadow-md transition-shadow"
                    >
                    ...
                    <div key={stack.category}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {stack.techs.map((tech) => (
                          <span
                            key={tech}
                            className="px-2 py-1 bg-white border rounded text-sm font-medium text-slate-700"
                          >
                            {tech}
                          </span>
                        ))}
